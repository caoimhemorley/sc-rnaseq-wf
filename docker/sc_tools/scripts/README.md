...
- _cell transcriptional phenotype_: [`transcriptional_phenotype.py`](./main/transcriptional_phenotype.py)
...
- _assign remaining cells_: [`label_scanvi.py`](./main/label_scvi.py)
    - `scANVI` leverage cell-type from MMC to assign the rest of the cells

- _UMAP clustering_: [`clustering_umap.py`](./main/clustering_umap.py)
...
- _`SCIB` METRICS_: [`artifact_metrics.py`](./main/artifact_metrics.py)
    - Integration metrics
